...
function UserInformation() {
    ...
    const { setStep, selectedSlots, setBookedAppointment } = context;

    useEffect(() => {
        const userTimeZone = Intl.DateTimeFormat().resolvedOptions().timeZone || 'America/New_York';
        const parsed: any = selectedSlots?.date
            ? DateTime.fromFormat(selectedSlots?.date, "yyyy-MM-dd HH:mm:ss ZZZ", { zone: 'Asia/Kolkata' })
            : "";
    ...
    const { data: offerId } = useQuery(GET_OFFERING_DETAILS, {
